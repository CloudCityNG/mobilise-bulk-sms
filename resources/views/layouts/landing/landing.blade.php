...
<head>
    <meta charset="utf-8">
    <title>Quic SMS Messaging Platform</title>
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="bs-navbar">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Messaging <span class="caret"></span></a>
...
<header id="first">
    <div class="header-content">
        <div class="inner">
            <h1 class="cursive">High reliability mobile messaging platform</h1>
            <h4>Real messaging solutions for your customers & clients</h4>
            <hr>
