<div id="tm-offcanvas" class="uk-offcanvas">
    <div class="uk-offcanvas-bar">
        <ul class="uk-nav uk-nav-offcanvas uk-nav-parent-icon" data-uk-nav="{multiple:true}">
            <li class="uk-parent"><a href="#">Messaging</a>
                <ul class="uk-nav-sub">
                    <li><a href="#">Quick SMS</a></li>
                    <li><a href="#">Bulk SMS</a></li>
                    <li><a href="#">Excel 2 SMS</a></li>
                    <li><a href="#">CSV 2 SMS</a>
                </ul>
            </li>
            {{--<li class="uk-nav-header">Core</li>--}}
            <li class="uk-parent"><a href="#"><i class="uk-icon-wrench"></i> Address Book</a>
                <ul class="uk-nav-sub">
            ...
            <li class="uk-parent uk-active"><a href="#"><i class="uk-icon-bars"></i> {{ucfirst($currentUser->username)}}</a>
                <ul class="uk-nav-sub">
                    ...
                    <li><a href="#">Buy SMS Credit</a></li>
                    <li><a href="#">Transfer SMS Credit</a></li>
                </ul>
            </li>
