                        ...
                        <table class="twelve columns">
                          <tr>
                            ...
                            <td class="six sub-columns last" style="text-align:right; vertical-align:middle;">
                              <span class="template-label">Welcome Email</span>
                            </td>
                    ...
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            <h1>Hi, {{$username}}</h1>
                						<p class="lead">Welcome to Mobilise Bulk SMS and thanks for signing up.</p>
                						<p>
                      ...
                      <table class="six columns">
                        <tr>
                          <td class="last right-text-pad">
                            ...
                            <p>Email: <a href="mailto:support@mobiliseafrica.com">support@mobiliseafrica.com</a></p>
                          </td>
                          <td class="expander"></td>
                        </tr>
                      </table>
